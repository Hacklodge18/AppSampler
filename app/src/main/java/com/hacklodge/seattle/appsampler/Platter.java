...
public class Platter extends AppCompatActivity {
    ...
    AppHolder app1 = new AppHolder("com.supercell.brawlstars","BrawlStar" , null);
    AppHolder app3 = new AppHolder("com.lemonjamstudio.infiniteknights","InfiniteKnight" , null);
    AppHolder app2 = new AppHolder("com.mochibits.wordtoword.google","wordtoword" , null);
    AppHolder app4 = new AppHolder("om.pinestreetcodeworks.TinyBubbles","TinnyBubbles" , null);
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appB2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                InstallUtility.install(view.getContext() , app2 , Manager);
            }
        });
        ...
        appB3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                InstallUtility.install(view.getContext() , app3 , Manager);
            }
        });
        ...
        appB4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                InstallUtility.install(view.getContext() , app4 , Manager);
            }
        });
    }
}
